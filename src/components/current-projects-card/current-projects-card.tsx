...
const CurrentProjectsCard: FC<TProps> = ({ cardData }) => {
  return (
    <div className={`${styles.container} container`}>
      <div
        className={`${styles.heading_wrapper} container bg-gradient_type_medium`}
      >
        <img
        ...
        <div className={`${styles.title_wrapper} container`}>
          ...
          {cardData.titleExtra && (
            <div
              className={`${styles.title_extra} container text text_type_normal`}
            >
              {cardData.titleExtra.map((item, index) => {
                return (
                  <ListItem extraClass="w-5" key={index}>
                    <span>{item}</span>
                  </ListItem>
                );
              })}
      ...
      <div className={`${styles.categories_wrapper} container`}>
        <div className={`${styles.role_category_wrapper} container`}>
          <div
            className={`${styles.category_name_wrapper} container text text_type_normal`}
          >
            <img
          ...
          <div
            className={`${styles.role_content_wrapper} container text text_type_normal`}
          >
            {cardData.role.contentList &&
              cardData.role.contentList.map((item, index) => {
                return (
                  <ListItem icon={item.icon} key={index}>
                    <span>{item.text}</span>
                  </ListItem>
                );
              })}
        ...
        <div
          className={`${styles.category_wrapper} container bg-gradient_type_medium`}
        >
          <div
            className={`${styles.category_name_wrapper} container text text_type_normal`}
          >
            <img
              ...
              className={`${styles.icon} image`}
            />
            <span>{cardData.area.category.text}</span>
          </div>
          ...
          <div className={`${styles.category_wrapper} container`}>
            ...
            >
              <img
                ...
                className={`${styles.icon} image`}
              />
              <span>{cardData.period.category.text}</span>
            </div>
            {cardData.period.content && (
              <span
                className={`${styles.category_content} text text_type_bold`}
              >
                {cardData.period.content}
              </span>
            )}
          ...
          >
            ...
            >
              <img
                ...
                className={`${styles.icon} image`}
              />
              <span>{cardData.investment.category.text}</span>
            </div>
        ...
        <div className={`${styles.category_wrapper} container`}>
          ...
          >
            <img
              ...
              className={`${styles.icon} image`}
            />
            <span>{cardData.cost.category.text}</span>
          </div>
